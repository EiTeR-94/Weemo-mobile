...
final class WineAPI {
    ...
    // bis
    private static let nativeClientValue = "native-ios-bis"
    private static let userAgentOwner = "WeenoBis/0.1.0 (iPhone; native owner) [lan-vpn]"
    private static let userAgentInvite = "WeenoBis/0.1.0 (iPhone; native invite) [wan]"

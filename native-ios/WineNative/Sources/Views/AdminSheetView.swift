...
struct AdminSheetView: View {
    ...
    @State private var vivinoBearerDraft = ""
    @State private var vivinoUserIdDraft = ""
    @State private var vivinoTokenConfigured = false
    ...
    private var visionStatusCard: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("Scan Vivino (depuis l’iPhone)")
                .font(.system(size: 13, weight: .semibold))
            ...
            HStack(spacing: 8) {
                ...
                WeenoSecondaryButton(title: "Effacer") {
                    ...
                    VivinoTokenStore.userId = nil
                    vivinoBearerDraft = ""
                    vivinoUserIdDraft = ""
                    vivinoTokenConfigured = false

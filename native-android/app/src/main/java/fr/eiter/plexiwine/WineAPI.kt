...
class WineAPI private constructor(context: Context) {
    companion object {
        ...
        private const val NATIVE_CLIENT_VALUE = "native-android-bis"
        private const val USER_AGENT_OWNER = "WeenoBis/0.1.0 (Android; native owner) [lan-vpn]"
        private const val USER_AGENT_INVITE = "WeenoBis/0.1.0 (Android; native invite) [wan]"
    ...
    suspend fun sendFeedback(
        ...
        return try {
            val payload = mutableMapOf<String, Any>(
                ...
                "client_info" to "native-android-bis",
